...
open class WristokeReceiver(context: Context): MessageApi.MessageListener {

    var TAG = "Wristroke Receiver 49"
    var debug = false
        ...
        mGoogleApiClient = GoogleApiClient.Builder(context)
                ...
                .addConnectionCallbacks(object : GoogleApiClient.ConnectionCallbacks {
                    override fun onConnected(bundle: Bundle?) {
                        ...
                        Wearable.MessageApi.addListener(mGoogleApiClient, this@WristokeReceiver)
                    }
...
//                        (data[2].toShort() * speed).toShort())
    ...
    open fun test1(num: Int) {    }
    open fun test2(num: Int) {    }
}